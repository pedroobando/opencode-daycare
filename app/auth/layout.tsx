  ...
  return (
    <div className="grid min-h-screen grid-cols-1 bg-background md:grid-cols-[1.05fr_1fr]">
      ...
      <aside className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-[#F6A98E] via-[#F2937A] to-[#EC7E62] p-14 text-white md:flex">
        {/* Decorative circles */}
        <div className="absolute -right-30 -top-35 h-[420px] w-[420px] rounded-full bg-white/12" />
        <div className="absolute -bottom-28 -left-20 h-[300px] w-[300px] rounded-full bg-white/10" />

        <div className="relative flex items-center gap-3.5">
          <div className="flex h-11 w-11 items-center justify-center rounded-[14px] bg-white/22">
        ...
        <div className="relative max-w-[430px]">
          ...
          <p className="mt-4 text-[17px] leading-relaxed text-white/92">
